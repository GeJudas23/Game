...
{
    private int barWidth = 32; // the width of the color portion of the bar
    private int barHeight = 4; // the height of the color portion of the bar
...
//  The color of the bar AT the breakpoint will be the average color between the safe color and the danger color
    private float fontSize = 16.0f; // the size of the text
    ...
    {   
        ...
        if (value == 0){getWorld().removeObject(this);}
    }
